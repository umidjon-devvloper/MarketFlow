      ...
      <div className="hidden lg:flex w-[45%] relative flex-col justify-between p-12 bg-ink overflow-hidden">
        ...
        <div className="relative z-10 max-w-md animate-fade-up">
          ...
          <h2 className="text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-[1.1]">
            Xush kelibsiz, <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#a890ff] to-[#5b9bff]">qaytayotganingizdan xursandmiz</span>
          </h2>
          <p className="mt-5 text-lg text-white/60 font-medium leading-relaxed">
            O'z do'konlaringiz savdosini tezkor nazorat qiling va barcha buyurtmalarni bir joydan boshqaring.
          </p>
          ...
          <div className="mt-12 w-full glass bg-white/5 border-white/10 rounded-2xl p-6 relative overflow-hidden group">
            ...
            <div className="flex items-center justify-between relative z-10">
              <div>
                <p className="text-white/60 text-sm font-medium mb-1">Bugungi buyurtmalar</p>
                <p className="text-2xl font-bold text-white">+142 ta yangi</p>
              </div>
              <div className="w-12 h-12 rounded-full bg-ozon/20 flex items-center justify-center text-ozon">
      ...
      <div className="w-full lg:w-[55%] relative flex items-center justify-center p-6 sm:p-12">
        ...
        <div className="relative z-10 w-full max-w-[420px]">
          <div className="text-center lg:text-left mb-10 animate-fade-down">
            <h1 className="text-3xl font-extrabold text-ink tracking-tight">Tizimga kirish</h1>
            <p className="text-ink-soft text-[0.95rem] mt-2 font-medium">Davom etish uchun hisobingizga kiring</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="glass bg-paper/70 p-7 sm:p-9 rounded-[28px] shadow-card border border-line/60 animate-fade-up backdrop-blur-xl">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="block text-[0.85rem] font-bold text-ink">Parol</label>
                  <Link href="/forgot-password" className="text-[0.8rem] text-accent font-medium hover:text-indigo transition-colors">Parolni unutdingizmi?</Link>
                </div>
                <input
                  type="password"
                  {...register('password')}
            ...
            <p className="text-center lg:text-left text-[0.9rem] text-ink-soft mt-8 font-medium">
              Hisobingiz yo'qmi?{' '}
              <Link href="/register" className="text-accent font-bold hover:text-indigo transition-colors relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[2px] after:bg-accent after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:origin-left">
                Ro'yxatdan o'ting
              </Link>
            </p>
          </form>
