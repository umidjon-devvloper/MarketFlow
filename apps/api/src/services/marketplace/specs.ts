    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          hint: 'Uzum shablonida "Состав RU" ustuni',
        },
        {
          key: 'materialUz',
          label: "Material / tarkib (o'zbekcha)",
          excelHeader: 'Material (UZ)',
          type: 'text',
          lang: 'uz',
          required: false,
          aiFillable: true,
          placeholder: '100% paxta',
          hint: 'Uzum shablonida "Состав UZ" ustuni',
        },
        {
          key: 'country',
  ...
  groups: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'vat', label: 'QQS (НДС)', excelHeader: 'НДС, %', type: 'select', required: true, options: ['0%', '12%', '10%', '20%'], hint: "Do'koningizga bog'liq. O'zbekistondagi do'konda 0% o'tdi, 20% va 12% rad etildi" },
      ],
    },
    {
      key: 'attrs',
